...
Write a SQL query to retrieve all transactions where: Category is Clothing Quantity sold is more than 4 Sale occurred in November 2022

Write a SQL query to calculate the total sales (total_sale) for each category.

Write a SQL query to find the average age of customers who purchased items from the Beauty category.

Write a SQL query to find all transactions where the total sale value is greater than 1000.
...
Write a SQL query to classify sales into shifts and count the number of orders in each shift:

Morning: Before 12 PM Afternoon: Between 12 PM and 5 PM Evening: After 5 PM

Write a SQL query to calculate the average monthly sales and identify the best-selling month for each year.
